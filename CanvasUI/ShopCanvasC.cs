...
public class ShopCanvasC : MonoBehaviour{
	...
	void Start(){
		player = GlobalCondition.mainPlayer;
		SetMaxPage();
		UpdateUi();
	}
	...
	void SetMaxPage(){
		...
		if(mode == 1){
			//Sell Usable Item
			maxPage = player.GetComponent<Inventory>().itemSlot.Length / shupUi.Length;
			if(player.GetComponent<Inventory>().itemSlot.Length % shupUi.Length != 0){
				maxPage += 1;
			}
		}
		if(mode == 2){
			//Sell Equipment
			maxPage = player.GetComponent<Inventory>().equipment.Length / shupUi.Length;
			if(player.GetComponent<Inventory>().equipment.Length % shupUi.Length != 0){
				maxPage += 1;
			}
		}
		...
		if(mode == 1){
			...
			for(int a = 0; a < shupUi.Length; a++){
				if(a + cPage < player.GetComponent<Inventory>().itemSlot.Length && player.GetComponent<Inventory>().itemSlot[a + cPage] > 0){
					shupUi[a].itemIcons.sprite = database.usableItem[player.GetComponent<Inventory>().itemSlot[a + cPage]].iconSprite;
					shupUi[a].itemIcons.color = database.usableItem[player.GetComponent<Inventory>().itemSlot[a + cPage]].spriteColor;
					
					shupUi[a].itemNameText.text = database.usableItem[player.GetComponent<Inventory>().itemSlot[a + cPage]].itemName + " x " + player.GetComponent<Inventory>().itemQuantity[a + cPage].ToString();
					shupUi[a].priceText.text = ": " + (database.usableItem[player.GetComponent<Inventory>().itemSlot[a + cPage]].price /2).ToString();
				}else{
					//Out of Range
					shupUi[a].itemIcons.sprite = null;
					shupUi[a].itemNameText.text = "";
		...
		if(mode == 2){
			...
			for(int a = 0; a < shupUi.Length; a++){
				if(a + cPage < player.GetComponent<Inventory>().equipment.Length && player.GetComponent<Inventory>().equipment[a + cPage] > 0){
					shupUi[a].itemIcons.sprite = database.equipment[player.GetComponent<Inventory>().equipment[a + cPage]].iconSprite;
					shupUi[a].itemIcons.color = database.equipment[player.GetComponent<Inventory>().equipment[a + cPage]].spriteColor;
					
					shupUi[a].itemNameText.text = database.equipment[player.GetComponent<Inventory>().equipment[a + cPage]].itemName;
					shupUi[a].priceText.text = ": " + (database.equipment[player.GetComponent<Inventory>().equipment[a + cPage]].price /2).ToString();
				}else{
					//Out of Range
					shupUi[a].itemIcons.sprite = null;
					shupUi[a].itemNameText.text = "";
	...
	public void ShowTooltip(int slot){
		...
		if(mode == 1){
			...
			tooltipIcon.sprite = database.usableItem[player.GetComponent<Inventory>().itemSlot[slot]].iconSprite;
			...
			tooltipText2.text = database.usableItem[player.GetComponent<Inventory>().itemSlot[slot]].description2;
			tooltipText3.text = database.usableItem[player.GetComponent<Inventory>().itemSlot[slot]].description3;
		...
		if(mode == 2){
			...
			tooltipIcon.sprite = database.equipment[player.GetComponent<Inventory>().equipment[slot]].iconSprite;
			...
			tooltipText2.text = database.equipment[player.GetComponent<Inventory>().equipment[slot]].description2;
			tooltipText3.text = database.equipment[player.GetComponent<Inventory>().equipment[slot]].description3;
